...
const AddPurchaseRebate = () => {
  ...
  const handleSearch = async (overrideNumber = null) => {
    ...
    // Immediately close suggestions dropdown on search execution
    setShowSuggestions(false);
    setFilteredSuggestions([]);
    setHighlightedIndex(-1);
  ...
  return (
    <div className="add-purchase-wrapper" style={{width:'100%',marginBottom:'90px'}}>
      ...
      <div style={{ textAlign: 'center', alignItems: 'center' }} className="po-header">
        <h2 style={{ fontSize: '22px',fontWeight:'400px', color: '#3e576c', fontFamily: 'times new roman' }}>Purchase Rebate Management</h2>
        
      </div>

      {/* Search Section with proper z-index and positioning */}
          ...
          <div style={{ backgroundColor: '#fff', borderRadius: '12px', padding: '28px', maxWidth: '420px', width: '90%', boxShadow: '0 20px 60px rgba(0,0,0,0.3)', borderTop: '6px solid #1f6b3a' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '12px' }}>
              <button 
                ...
                style={{ padding: '10px 24px', backgroundColor: '#f1f1f1', border: 'none', borderRadius: '6px', cursor: 'pointer', fontWeight: '600', color: '#333' }}
              >
                Cancel (Esc)
              </button>
              <button 

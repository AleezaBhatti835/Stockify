  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        @keyframes floatGlow {
          0% { transform: translateY(0px); box-shadow: 0 0 20px rgba(255,255,255,0.05); }
          50% { transform: translateY(-8px); box-shadow: 0 0 35px rgba(255,255,255,0.25); }
          100% { transform: translateY(0px); box-shadow: 0 0 20px rgba(255,255,255,0.05); }
        }
        ...
        /* STRICT OVERRIDES FOR INPUTS */
        input.clean-input, 
        input.clean-input:hover, 
        input.clean-input:focus, 
        input.clean-input:active {
          background-color: #ffffff !important;
          color: #1e293b !important; /* Forces dark text instead of white */
        ...
        /* Fix for browser autofill yellow/grey background */
        input.clean-input:-webkit-autofill,
        input.clean-input:-webkit-autofill:hover, 
        input.clean-input:-webkit-autofill:focus, 
        input.clean-input:-webkit-autofill:active {
          -webkit-box-shadow: 0 0 0 30px #ffffff inset !important;
          -webkit-text-fill-color: #1e293b !important;
          transition: background-color 5000s ease-in-out 0s !important;
        }

        /* Override placeholder color for visibility */
      ...
      <div className="card" style={{
        ...
        <div style={{
          ...
          <h1 className="brand-stagger-1" style={{ 
            margin: '0 0 14px 0', 
            fontSize: '28px', 
            fontWeight: '800', 
            letterSpacing: '0.5px' 
          ...
          <p className="brand-stagger-2" style={{ 
            margin: '0 0 35px 0', 
            fontSize: '14px', 
            lineHeight: '1.6', 
            opacity: 0.9, 
          ...
          <p className="brand-stagger-4" style={{ 
            margin: 0, 
            fontSize: '13px', 
            opacity: 0.8 
          }}>
        ...
        <div style={{
          ...
          <div className="animate-stagger-1" style={{ marginBottom: '24px', textAlign: 'center' }}>
            <h2 style={{ margin: '0 0 6px 0', fontSize: '24px', color: 'var(--text-main)', fontWeight: '700' }}>Welcome Back</h2>
            <p style={{ margin: 0, fontSize: '13px', color: 'var(--text-muted)' }}>Sign in to continue to your dashboard</p>
          </div>
          ...
          <form onSubmit={handleLogin}>
              ...
              <div style={{ position: 'relative' }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    border: 'none',
                    cursor: 'pointer',
                    color: '#94a3b8', /* Ensures eye icon is visible */
                    padding: '4px',
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
            ...
            <div className="animate-stagger-3" style={{ marginBottom: '24px', display: 'flex', justifyContent: 'flex-start' }}>
              <label style={{ 
                display: 'inline-flex', 
                alignItems: 'center', 
                gap: '8px', 
                ...
                <div style={{
                  ...
                  height: '16px',
                  borderRadius: '4px',
                  border: `1px solid ${rememberMe ? 'var(--primary)' : 'var(--border-color)'}`,
                  backgroundColor: rememberMe ? 'var(--primary)' : '#ffffff',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
            ...
            <button
              type="submit"
              className="btn btn-primary animate-stagger-4"
              style={{
                width: '100%',
                padding: '12px',
                fontSize: '14px',
